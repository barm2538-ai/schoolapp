...
import LibraryResourceForm from '../../components/LibraryResourceForm';
...
export default function LibraryPage() {
  ...
  useEffect(() => {
    const q = query(collection(db, 'libraryResources'));
    ...
    <>
      <div className="w-full max-w-5xl">
        <div className="flex justify-between items-center mb-8">
            <h1 className="text-3xl font-bold">จัดการห้องสมุดออนไลน์</h1>
